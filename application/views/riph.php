...
<head>
    ...
    <title>SIBANPEM - Sistem Bantuan Pemerintah</title>
    <!-- Bootstrap Core CSS -->
    ...
    <div id="main-wrapper">
                                ...
                                <ul class="mega-dropdown-menu row">
                                        ...
                                        <div id="accordion" class="nav-accordion" role="tablist"
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseOne" class="collapse show" role="tabpanel"
                                                    ...
                                                    <div class="card-body"> SiMevi adalah sebuah Sistem Informasi yang
                                                        bertujuan untuk Melakukan Monitoring Evaluasi dan Pengawalan
                                                        Agroindustri Hortikultura Indonesia. </div>
                                                </div>
                                            </div>
                                            <div class="card">
                                                ...
                                                <div id="collapseTwo" class="collapse" role="tabpanel"
                                                    ...
                                                    <div class="card-body"> Pada Prinsipnya semua Sistem Informasi yang
                                                        ada di Direktorat Jenderal Hortikultura Bisa, Tapi kami baru
                                                        bisa menghubungkan SiBanpem, SiMETHRIS dan SiPedas</div>
                                                </div>
                                            </div>
                                        </div>
                                    </li>
                                    ...
                                    <li class="col-lg-3 col-xlg-4 m-b-30">
                                        ...
                                        <ul class="list-style-none">
                                            <li><a href="https://www.pertanian.go.id"><i
                                                        class="fa fa-check text-success"></i> Kementerian Pertanian</a>
                                            </li>
                                            <li><a href="http://hortikultura.pertanian.go.id"><i
                                                        class="fa fa-check text-success"></i> Ditjen Hortikultura</a>
                                            </li>
                                        </ul>
                                    </li>
                                </ul>
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i
                                    class="mdi mdi-gauge"></i><span class="hide-menu">SiMEVI</span></a>
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false" id="judul"><i
                                    class="mdi mdi-chevron-double-right"></i><span class="hide-menu">Sistem Monitoring
                                    Evaluasi dan Pengawalan Agroindustri Hortikultura Indonesia</span></a>
                        </li>
                    </ul>
                </nav>
        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-3 bgimg">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="text-center db"><img
                                        src="<?php echo base_url('assets/') ?>images/logo_dirjen.png" width="125px">
                                </div>
                            </div>
                            <div class="col-12">
                                <br>
                                <br>
                                <div class="text-center db"><img
                                        src="<?php echo base_url('assets/') ?>images/logo-simevi.png" width="125px">
                                </div>
                            </div>
                        </div>
                        <div class="row kahandap">
                            <div class="col-lg-12">
                                <ul id="hexGrid">
                                    <li class="hex">
                                        <div class="hexIn">
                                            <a class="hexLink" href="<?php echo base_url('auth/login') ?>"
                                                data-toggle="tooltip" data-placement="top" title="SiMEVI">
                                    ...
                                    <li class="hex">
                                        <div class="hexIn">
                                            <a class="hexLink" href="<?php echo base_url('sibanpem') ?>"
                                                data-toggle="tooltip" data-placement="top" title="SiBANPEM">
                                    ...
                                    <li class="hex">
                                        <div class="hexIn">
                                            <a class="hexLink" href="<?php echo base_url('simethris') ?>"
                                                data-toggle="tooltip" data-placement="top" title="SiMETHRIS">
                                    ...
                                    <li class="hex">
                                        <div class="hexIn">
                                            <a class="hexLink" href="#" data-toggle="tooltip" data-placement="top"
                                                title="SiPEDAS">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="text-center db">
                                    <h1 class="text-themecolor">S i M E V I</h1>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-9">
                        <div id="carouselExampleIndicators3" class="carousel slide d-none d-md-block"
                            data-ride="carousel">
                            ...
                            <div class="carousel-inner" role="listbox">
                                <div class="carousel-item active">
                                    <img class="d-block w-100"
                                        src="<?php echo base_url('assets/') ?>images/big/simevi.jpg" alt="Third slide">
                                    <div class="carousel-caption bg-theme">
                                        <h3 class="text-white">SiMEVI</h3>
                                        <p class="text-white">Sistem Monitoring dan Evaluasi Agroindustri Hortikultura
                                            Indonesia</p>
                                    </div>
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100"
                                        src="<?php echo base_url('assets/') ?>images/big/sibanpem.jpg"
                                        alt="Third slide">
                                    <div class="carousel-caption d-none d-md-block bg-theme">
                                        <h3 class="text-white"><b>SiBANPEM</h3>
                                        <p>Sistem Informasi Bantuan Pemerintah</b></p>
                                    </div>
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100"
                                        src="<?php echo base_url('assets/') ?>images/big/simethris.jpg"
                                        alt="Third slide">
                                    <div class="carousel-caption d-none d-md-block bg-theme">
                                        <h3 class="text-white"><b>SiMETHRIS</h3>
                                        <p>Sistem Monitoring Wajib Tanam Hortikultura Strategis</b></p>
                                    </div>
                                </div>
                                <div class="carousel-item">
                                    <img class="d-block w-100"
                                        src="<?php echo base_url('assets/') ?>images/big/sipedas.jpg" alt="Third slide">
                                    <div class="carousel-caption bg-theme">
                                        <h3 class="text-white">SiPEDAS</h3>
                                        <p>Sistem Penyediaan Data Statistik Pertanian Hortikultura</p>
                                    </div>
                                </div>
                            </div>
            ...
            <footer class="footer">
                ...
                </script>, made with <i class="mdi mdi-heart text-danger"></i> by <a
                    href="http://hortikultura.pertanian.go.id">Tim Pengembang Hortikultura</a>
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
