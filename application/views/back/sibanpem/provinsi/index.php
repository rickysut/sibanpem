...
<?php $this->load->view('back/template/sidebar_no_login'); ?>
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-header">
								<img src="<?php echo base_url('assets/images/logo/').$logoProv ?>"><span> Provinsi <?php echo $namaProv; ?></span>
								...
								<div id="accordion" role="tablist">
									  ...
									  <div class="card-header" role="tab" id="headingOne">
										<h5 class="mb-0">
										  <a data-toggle="collapse" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne" class="collapsed">
											...
											<span class="expand-icon-wrap"><i class="fa fa-angle-down float-right" aria-hidden="true"></i></span>
										  </a>
										</h5>
									  </div>
									  <div id="collapseOne" class="collapse" role="tabpanel" aria-labelledby="headingOne" data-parent="#accordion" style="">
										<div class="card-body">
										  <div class="table-responsive">
												<table id="tablekegiatan"  class="table display table-hover" cellspacing="0" style="undefined;table-layout: fixed; width: 100%">
													<colgroup>
									...
									<div class="card-collapse">
									  ...
									  <div id="collapseTwo" class="collapse" role="tabpanel" aria-labelledby="headingTwo" data-parent="#accordion">
										<div class="card-body">
											<div class="table-responsive">
												<table id="tableakun" class="table display table-hover" cellspacing="0" style="undefined;table-layout: fixed; width: 100%">
												  <colgroup>
													<col style="width: 51px">
													<col style="width: 372px">
													<col style="width: 149px">
									...
									<div class="card-collapse">
									  <div class="card-header" role="tab" id="headingThree">
										<h5 class="mb-0">
										  <a class="collapsed show" data-toggle="collapse" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
									  ...
									  <div id="collapseThree" class="collapse" role="tabpanel" aria-labelledby="headingThree" data-parent="#accordion">
										<div class="card-body">
											<ul class="nav nav-pills m-t-30 m-b-30">
												<li class=" nav-item"> <a href="#navpills-1" class="nav-link" data-toggle="tab" aria-expanded="false">2019</a> </li>
												<li class=" nav-item"> <a href="#navpills-2" class="nav-link" data-toggle="tab" aria-expanded="false">2019</a> </li>
												<li class="nav-item"> <a href="#navpills-3" class="nav-link" data-toggle="tab" aria-expanded="false">2020</a> </li>
												<li class="nav-item"> <a href="#navpills-4" class="nav-link active" data-toggle="tab" aria-expanded="true">2021</a> </li>
											</ul>
											<div class="tab-content br-n pn">
												...
												<div id="navpills-4" class="tab-pane active">
													<div class="row">
														<div class="table-responsive">
															<table id="table2021" class="table display table-hover" cellspacing="0" style="undefined;table-layout: fixed; width: 100%">
																<colgroup>
																	<col style="width: 51px">
		...
		<div class="modal-dialog modal-xl">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="table-responsive">
								<table id="tableSatkerKab" class="table table-striped table-no-bordered table-hover" cellspacing="0" width="100%" style="width:100%">
								  <thead>
									<tr>
