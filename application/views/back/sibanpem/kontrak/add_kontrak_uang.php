                            ...
                            <div class="row p-t-20">
                                <div class="col-md-4">
                                    <div class="form-group has-success">
                                        ...
                                        <small class="form-control-feedback"> Diisi Nomor DIPA </small>
                                    </div>
                                </div>
                                <!--/span-->
                                <div class="col-md-4">
                                    <div class="form-group has-success">
                                        ...
                                        <input type="date" id="k_dipa_tgl" class="form-control"
                                            placeholder="mm/dd/yyyy">
                                        <small class="form-control-feedback"> Tanggal DIPA. </small>
                                    </div>
                                </div>
                                <!--/span-->
                                <div class="col-md-4">
                                    <div class="form-group has-success">
                                        ...
                                        <small class="form-control-feedback"> Pilih Kode Kegiatan </small>
                                    </div>
                                </div>
                            </div>
                            <!--/row-->
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group has-success">
                                        ...
                                        <small class="form-control-feedback"> Pilih Kode KRO </small>
                                    </div>
                                </div>
                                <!--/span-->
                                <div class="col-md-4">
                                    <div class="form-group has-success">
                                        ...
                                        <small class="form-control-feedback"> Pilih Kode RO </small>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group has-success">
                                        ...
                                        <small class="form-control-feedback"> Pilih Kode Akun Belanja </small>
                                    </div>
                                </div>
                                <!--/span-->
                            </div>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group has-success">
                                        ...
                                        <small class="form-control-feedback"> Diisi Nomor Kontrak </small>
                                    </div>
                                </div>
                                <!--/span-->
                                <div class="col-md-4">
                                    <div class="form-group has-success">
                                        ...
                                        <input type="date" id="k_kontrak_tgl" class="form-control"
                                            placeholder="mm/dd/yyyy">
                                        <small class="form-control-feedback"> Diisi Tanggal Kontrak. </small>
                                    </div>
                                </div>
                                <!--/span-->
                                <div class="col-md-4">
                                    <div class="form-group has-success">
                                        ...
                                        <small class="form-control-feedback"> Pilih Ya atau Tidak </small>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-body">
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    <div class="card">
                                        <div class="card-body">
                                            <h4 class="card-title">Berkas Perjanjian Kerja</h4>
                                            <label for="input-file-now">Ukuran hasil pemindaian berkas untuk diunggah
                                                maksimum 2MB</label>
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <label for="input-file-now-custom-1">Ukuran hasil pemindaian berkas untuk
                                                diunggah maksimum 2MB</label>
                    ...
                    <div class="card-body collapse show">
                        <div class="form-body">
                            <div class="row">
                                <div class="col-md-12 ">
                                    <div class="form-group has-success">
                                        <label>Nilai Bantuan Uang</label>
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body collapse show">
                        ...
                        <h6 class="card-subtitle">Daftar Penerima Bantuan Barang Berdasarkan Kontrak</h6>
                        <div class="form-body">
                            <div class="row">
