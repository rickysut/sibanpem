...
<div class="modal fade rotate" id="update-employee" style="display:none;">
        ...
        <form id="update-employee-form" method="post">   
            <div class="modal-content panel panel-primary">
                ...
                <div class="modal-footer panel-footer">
                    <div class="row">
                        <div class="col-sm-12">                            
                            <button type="button" class="btn rkmd-btn btn-success" data-addempid="" id="update-emp">Update</button> 
