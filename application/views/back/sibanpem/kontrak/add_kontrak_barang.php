...
<div class="page-wrapper">
    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item">SIBANPEM</li>
                <li class="breadcrumb-item"><a href="<?php echo base_url('kontrak') ?>">Entry Penyaluran</a></li>
    ...
    <div class="container-fluid">
        ...
        <input type="hidden" id="k_tipe" name="k_tipe" value="Barang">
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body collapse show">
                        <div class="form-body">
                            <div class="row p-t-20">
                                <div class="col-md-12">
                                    <div class="form-group has-success">
                                        <label>Nomor SK CPCL</label>
                                        <?php echo form_input($k_kontrak_cpcl) ?>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group has-success">
                                        <label class="control-label">Nomor DIPA</label>
                                        <?php echo form_input($k_dipa) ?>
                                    </div>
                                </div>
                                <!--/span-->
                                <div class="col-md-4">
                                    <div class="form-group has-success">
                                        ...
                                        <?php echo form_input($k_dipa_tgl) ?>
                                    </div>
                                </div>
                                <!--/span-->
                                <div class="col-md-4">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group has-success">
                                        <label class="control-label">Klasifikasi Rincian Output</label>
                                        <?php echo form_dropdown('', $get_all_kro, '', $k_kode_kro) ?>
                                    </div>
                                </div>
                                <!--/span-->
                                <div class="col-md-4">
                                    <div class="form-group has-success">
                                        <label class="control-label">Rincian Output</label>
                                        <?php echo form_dropdown('', $get_all_ro, '', $k_kode_ro) ?>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group has-success">
                                        <label class="control-label">Kode Akun Belanja</label>
                                        <?php echo form_dropdown('', $get_all_akun, '', $k_kode_akun) ?>
                                    </div>
                                </div>
                                <!--/span-->
                            </div>
                            <div class="row">
                                <div class="col-lg-8 col-md-8">
                                    <div class="form-group has-success">
                                        ...
                                        <?php echo form_input($k_kontrak_nomor) ?>
                                    </div>
                                </div>
                                <!--/span-->
                                <div class="col-lg-4 col-md-4">
                                    <div class="form-group has-success">
                                        ...
                                        <?php echo form_input($k_kontrak_tgl) ?>
                                    </div>
                                </div>
                                <!--/span-->
                            </div>
                            <div class="row">
                                <div class="col-lg-6 col-md-6">
                                    <div class="form-group has-success">
                                        <label class="control-label">Titik Bagi Penyaluran</label>
                                        <select id="titikbagi" class="form-control custom-select"
                                            data-placeholder="Pilih Titik Bagi" tabindex="1">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="form-group has-success">
                                        <label class="control-label">Bantuan Kepada</label>
                                        <select id="penerima" class="form-control custom-select"
                                            data-placeholder="Pilih Penerima" tabindex="1">
                                ...
                                <div class="col-lg-6 col-md-6">
                                    <div class="form-group has-success">
                                        ...
                                        <?php echo form_input($k_kontrak_nilai) ?>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="form-group has-success">
                                        ...
                                        <div class="switch">
                                            <label>Tidak<input type="checkbox" id="is_ongkir"><span
                                                    class="lever"></span>Ya</label>
                                        </div>
                                    </div>
                                </div>
                                <!--/span-->
                                <div class="col-md-3">
                                    <div class="form-group has-success">
                                        ...
                                        <div class="switch">
                                            <label>Tidak<input type="checkbox" id="is_swakelola"><span
                                                    class="lever"></span>Ya</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group has-success">
                                        ...
                                        <div class="switch">
                                            <label>Tidak<input type="checkbox" id="is_langsung"><span
                                                    class="lever"></span>Ya</label>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="card-body collapse show">
                        <div class="row">
                            <div class="col-lg-6 col-md-6">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Berkas Kontrak</h4>
                                        <label for="k_kontrak_dokumen">Ukuran hasil pemindaian berkas untuk diunggah
                                            maksimum 2MB</label>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title">Berkas CPCL</h4>
                                        <label for="file_cpcl">Ukuran hasil pemindaian berkas untuk diunggah maksimum
                                            2MB</label>
                                        <input type="file" id="file_cpcl" class="dropify" />
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-footer">
                        <button type="submit" class="btn btn-success" data-addempid="" id="add-emp"> <i
                        ...
                        <div class="row">
                            <div class="col-lg-4 col-md-6">
                                <div class="form-group">
                                    <label class="control-label">Penyedia Barang/Vendor</label>
                                    <?php echo form_dropdown('', $get_all_vendor, '', $k_vendor_nama) ?>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6">
                                <div class="form-group">
                                    <label class="control-label">NPWP Penyedia Barang/Vendor</label>
                                    <?php echo form_input($k_vendor_npwp) ?>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6">
                                <div class="form-group">
                                    ...
                                    <a class="btn btn-block btn-outline-info" href="javascript:void(0)"
                                        id="tombolTambahSaprodi" title="Isi / Tambah Vendor" onclick="add_vendor()"><i
                                            class="mdi mdi-cash"></i> Tambah Vendor</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body collapse">
                        <a class="pull-right btn btn-sm btn-rounded btn-info" href="javascript:void(0)"
                            id="tombolTambahBarang" title="Isi / Tambah Barang" onclick="add_barang()"><i
                                class="mdi mdi-cash"></i> Tambah Barang</a>
                        <h4 class="card-title">Pemesanan Barang untuk Bantuan</h4>
                        <h6 class="card-subtitle">Daftar Pemesanan Barang untuk Bantuan sesuai Kontrak</h6>
                        <div class="form-body">
                            <div class="row">
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-body collapse show">
                        <a class="pull-right btn btn-sm btn-rounded btn-info" href="javascript:void(0)"
                            id="tombolTambahPenerima" title="Isi / Tambah Penerima Barang" onclick="add_penerima()"><i
                                class="mdi mdi-cash"></i>Tambah Penerima Bantuan</a>
                        <h4 class="card-title">Data Penerima Bantuan</h4>
                        <h6 class="card-subtitle">Daftar Penerima Bantuan Uang Berdasarkan Kontrak</h6>
                        <div class="form-body">
                            <div class="row">
                                <div class="col-12 m-t-30">
                                    <div class="card-deck">
