                ...
                <div class="navbar-collapse">
                    ...
                    <ul class="navbar-nav mr-auto mt-md-0">
                        ...
                        <li class="nav-item dropdown mega-dropdown"> <a
                            ...
                            <div class="dropdown-menu animated slideInUp" style="z-index:99">
                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href=""
                                ...
                                aria-expanded="false"><?php echo $this->session->name ?><span
                                    class="mdi mdi-chevron-down"></span></a>
                            <div class="dropdown-menu dropdown-menu-right scale-up">
                                <ul class="dropdown-user">

                                    <li><a
                                            href="<?php echo base_url('auth/update_profile/'.$this->session->id_users) ?>"><i
                                                class="ti-user"></i> Update Profile</a></li>
                                    <li><a href="<?php echo base_url('auth/change_password') ?>"><i
                                                class="ti-wallet"></i> Change
                                            Password</a></li>
