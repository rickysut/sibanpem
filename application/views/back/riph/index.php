...
<div class="row page-titles">
	<div class="col-md-5 align-self-center">
		<table class="table-responsive">
			<tr>
				<td><h3 class="text-themecolor">Dashboard RIPH (mockup)</h3></td>
			</tr>
			<tr>
				<td><h5><small class="text-muted">Rekomendasi Impor Produk Hortikultura</small></h5></td>
			</tr>
			<tr>
				<td><h6><small class="text-muted">(Data per Oktober 2021)</small></h6></td>
			</tr>
		</table>
	</div>
			...
			<div class="col-12">	
				<div class="card card-default">
					<div class="card-header">
						...
						<h4 class="card-title m-b-0 text-danger"><strong>PERHATIAN !!</strong></h4>
					</div>
					<div class="card-body collapse show alert-danger">
						<div class="row">
							<div class="col-12">
							VERIFIKASI DIPERLUKAN TERHADAP <strong class="font-weight-bold"> 3.156 </strong> DATA WAJIB TANAM (simeTHRis)
						</div>
						</div>
					</div>
				</div>
