						...
						<table id="dataTable" class="table table-bordered table-striped">
						  ...
						  <tbody>
							<?php $no = 1; foreach($get_all_deleted as $user){
							  ...
							  // action
							  $restore = '<a href="'.base_url('auth/restore/'.$user->id_users).'" class="btn btn-xs btn-info"><i class="fa fa-refresh"></i></a>';
							  $delete = '<a href="'.base_url('auth/delete_permanent/'.$user->id_users).'" onClick="return confirm(\'Are you sure to delete permanently?\');" class="btn btn-xs btn-danger"><i class="fa fa-remove"></i></a>';
							?>
							  <tr>
