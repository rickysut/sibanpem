...
class Authbanpem extends CI_Controller{
  ...
  public function __construct()
  {
    ...
    // template
		...
		$this->data['add_action'] = base_url('authbanpem/create');
	}
  ...
  function index()
  {
    ...
    $this->load->view('banpem/auth/user_list', $this->data);
  }
  ...
  function create()
  {
    ...
    $this->data['action']     = 'authbanpem/create_action';
    ...
    $this->load->view('banpem/auth/user_add', $this->data);
  ...
  function update($id)
  {
    ...
    if($this->data['user'])
    {
      ...
      $this->data['action']     = 'authbanpem/update_action';
      ...
      $this->load->view('banpem/auth/user_edit', $this->data);
    }
    else
    {
  ...
  function delete_permanent($id)
  {
    ...
    if($delete)
    {
      ...
      redirect('authbanpem/deleted_list');
    }
    else
    {
      $this->session->set_flashdata('message', '<div class="alert alert-danger">No data found</div>');
  ...
  function deleted_list()
  {
    ...
    $this->load->view('banpem/auth/user_deleted_list', $this->data);
  }
  ...
  function update_profile($id)
  {
    ...
    if($this->data['user'])
    {
      ...
      $this->load->view('banpem/auth/update_profile', $this->data);
    }
    else
    {
      $this->session->set_flashdata('message', '<div class="alert alert-danger">User not found</div>');
    ...
    else
    {
      if($_FILES['photo']['error'] <> 4)
      {
        ...
        else
        {
          ...
          $this->session->set_flashdata('message', '<div class="alert alert-success">Data update succesfully</div>');
          redirect('authbanpem/update_profile/'.$this->session->id_users);
        }
      }
      else
      {
  ...
  function change_password()
  {
    ...
    $this->data['action']     = 'authbanpem/change_password_action';
    ...
    $this->load->view('banpem/auth/change_password', $this->data);
  }
  ...
  function change_password_action()
  {
    ...
    else
    {
      ...
      redirect('authbanpem/change_password');
    }
  }
  ...
  function login()
  {
    ...
    $this->data['action']     = 'authbanpem/login';
    ...
    else
    {
      ...
      $this->load->view('banpem/auth/login', $this->data);
    }
  }
  ...
  function forgot_password()
  {
    ...
    $this->data['action']     = 'authbanpem/forgot_password_process';
    ...
    $this->load->view('banpem/auth/forgot_password', $this->data);
  }
    ...
    if(isset($_POST['submit']))
    {
      ...
      else
      {
        ...
        if(!$email_check)
        {
          ...
          redirect('authbanpem/forgot_password');
        }
        else
        {
          $hash = random_str(50);
          ...
          $mailContent = "
            ...
            <p><a href='".base_url('authbanpem/reset_password/'.$hash)."'>".$hash."</a></p>
  ...
  function reset_password($code = NULL)
  {
    ...
    else
    {
      ...
      $this->data['action'] = 'authbanpem/reset_password_process/'.$code;
      ...
      $this->load->view('banpem/auth/reset_password', $this->data);
  ...
  function log_list()
  {
    ...
    $this->load->view('banpem/authbanpem/log_list', $this->data);
  }
