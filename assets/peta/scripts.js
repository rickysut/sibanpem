...
function _topNav () {
  ...
  if (jQuery ('#header li.search i.fa').size () != 0) {
    jQuery (
      '#header .search-box, #header li.search i.fa'
    ).on ('click', function (e) {
      e.stopPropagation ();
    });
...
function _megaNavHorizontal () {
  ...
  jQuery (
    'body'
  ).on ('click', '#header button.nav-toggle, #header nav.main-nav', function (
    e
  ) {
    e.stopPropagation ();
  });
 ...
 **************************************************************** **/
function _toggle () {
  var $_t = this, previewParClosedHeight = 25;
      ...
      _btn.bind ('click', function (e) {
        ...
        var _message = jQuery (this).attr ('data-message'),
          ...
          _newestOnTop = jQuery (this).attr ('data-newestOnTop') == 'true'
            ? true
            : false,
          _preventDuplicates = jQuery (this).attr ('data-preventDuplicates') ==
            'true'
            ? true
            : false,
  ...
  if (_container.length > 0) {
    loadScript (plugin_path + 'form.masked/jquery.maskedinput.js', function () {
      _container.each (function () {
        ...
        (_format =
          _t.attr ('data-format') ||
          '(999) 999-999999'), (_placeholder = _t.attr ('data-placeholder') || 'X');
...
function _pickers () {
  ...
  if (_container_1.length > 0) {
    loadScript (
      plugin_path + 'bootstrap.datepicker/bootstrap-datepicker.min.js',
      function () {
        if (jQuery ().datepicker) {
          _container_1.each (function () {
            var _t = jQuery (this), _lang = _t.attr ('data-lang') || 'en';
            ...
            jQuery (this)
              .datepicker ({
                ...
                changeMonth: _t.attr ('data-changeMonth') == 'false'
                  ? false
                  : true,
                todayBtn: _t.attr ('data-todayBtn') == 'false'
                  ? false
                  : 'linked',
        ...
        if (jQuery ().pajinate) {
          _container.each (function () {
            ...
            _t.pajinate ({
              ...
              item_container_id: _t.attr ('data-pajinate-container') ||
                '.pajinate-container',
...
function _infiniteScroll () {
  ...
  if (_container.length > 0) {
    loadScript (
      ...
      function () {
        (_navSelector =
          _container.attr ('data-nextSelector') ||
          '#inf-load-nex'), (_itemSelector =
          _container.attr ('data-itemSelector') || '.item'), (_nextSelector =
          _navSelector + ' a');
        ...
        if (jQuery ().stepper) {
          jQuery (_container).each (function () {
            ...
            _t.stepper ({
              ...
              preventWheelAcceleration: _t.attr (
                'data-preventWheelAcceleration'
              ) == 'false'
                ? false
                : true,
        ...
        if (jQuery ().slimScroll) {
          jQuery ('.slimscroll').each (function () {
            ...
            jQuery (this).slimScroll ({
              ...
              alwaysVisible: jQuery (this).attr ('data-alwaysVisible') !=
                'false'
                ? true
                : false,
              ...
              wrapperClass: jQuery (this).attr ('data-wrapper-class') ||
                'slimScrollDiv',
 ...
 **************************************************************** **/
function _stickyKit () {
  if (jQuery ('.sticky-kit').length < 1 || window.width < 960) return;

  loadScript (
    plugin_path + 'jquery.sticky-kit/jquery.sticky-kit.min.js',
    function () {
      jQuery ('.sticky-kit').each (function () {
        var _t = jQuery (this),
          _offset =
            _t.data ('offset') || Number (jQuery ('#header').outerHeight ());
...
function _cookie_alert () {
  var _el = jQuery ('#cookie-alert'), _elCookie = _getCookie ('cookie-alert');
...
!(function (n) {
  n.fn.parallax = function (n, t, e) {
    ...
    (arguments.length < 1 || null === n) && (n = '50%'), (arguments.length <
      2 ||
      null === t) &&
      (t = 0.1), (arguments.length < 3 || null === e) &&
      (e = !0), i.each (function () {
  ...
  (b = (function () {
    ...
    function e (a) {
      null == a && (a = {}), (this.scrollCallback = f (
        this.scrollCallback,
        this
      )), (this.scrollHandler = f (this.scrollHandler, this)), (this.start = f (
        this.start,
        this
    ...
    return (e.prototype.defaults = {
      ...
      var c, e, f, g, h, i;
      for (
        (e = d (a)), (c = e.getPropertyCSSValue (b)), (i = this
          .vendors), (g = 0), (h = i.length);
        h > g;
        g++
      )
...
!(function (e, t, n) {
    ...
    for (var l in b)
      if (b.hasOwnProperty (l)) {
        ...
        for (
          ...
          (a = e[i]), (s = a.split ('.')), 1 === s.length
            ? (Modernizr[s[0]] = o)
            : (!Modernizr[s[0]] ||
                Modernizr[s[0]] instanceof Boolean ||
                (Modernizr[s[0]] = new Boolean (Modernizr[s[0]])), (Modernizr[
                s[0]
              ][s[1]] = o)), C.push ((o ? '' : 'no-') + s.join ('-'));
      }
  }
  function i (e) {
    ...
    if ('object' == typeof e) for (var n in e) N (e, n) && s (n, e[n]);
      ...
      (t = 'function' == typeof t ? t () : t), 1 == r.length
        ...
        : (!Modernizr[r[0]] ||
            ...
            (Modernizr[r[0]] = new Boolean (Modernizr[r[0]])), (Modernizr[r[0]][
            r[1]
          ] = t)), i ([
        (t && 0 != t ? '' : 'no-') + r.join ('-'),
  ...
  function f (e, n, r, o) {
    ...
    return (i = a ('style')), (i.type = 'text/css'), (i.id = 's' + f), (p.fake
      ? p
      : d).appendChild (i), p.appendChild (d), i.styleSheet
      ? (i.styleSheet.cssText = e)
      : i.appendChild (t.createTextNode (e)), (d.id = f), p.fake &&
      ((p.style.background = ''), (p.style.overflow = 'hidden'), (c =
        w.style.overflow), (w.style.overflow = 'hidden'), w.appendChild (
        p
      )), (s = n (d, e)), p.fake
  ...
  function v (e, t, o, i) {
    ...
    for ((p = e.length), (d = 0); p > d; d++)
      if (
        ((m = e[d]), (v = A.style[m]), c (m, '-') && (m = l (m)), A.style[m] !==
          n)
      ) {
  ...
  S ||
    !(function (e, t) {
      ...
      function l (e, t) {
        t.cache ||
          ((t.cache = {}), (t.createElem = e.createElement), (t.createFrag =
            e.createDocumentFragment), (t.frag = t.createFrag ())), (e.createElement = function (
          n
        ) {
      ...
      !(function () {
        try {
          ...
          (e.innerHTML = '<xyz></xyz>'), (u = 'hidden' in e), (f =
      ...
      (e.html5 = C), c (t), 'object' == typeof module &&
        module.exports &&
        (module.exports = C);
  ...
  var P = (function () {
    function e (e, t) {
      var o;
      return e
        ? ((t && 'string' != typeof t) || (t = a (t || 'div')), (e =
            'on' + e), (o = e in t), !o &&
            r &&
            (t.setAttribute || (t = a ('div')), t.setAttribute (e, ''), (o =
              'function' == typeof t[e]), t[e] !== n &&
              (t[e] = n), t.removeAttribute (e)), o)
        : !1;
    }
  ...
  !(function () {
    ...
    N = r (e, 'undefined') || r (e.call, 'undefined')
      ? function (e, t) {
  ...
  var F = function (t) {
    ...
    if (
      ((t = t.replace (/^@/, '')), (r =
        t.replace (/-/g, '_').toUpperCase () + '_RULE'), r in i)
    )
      return '@' + t;
    for (var a = 0; o > a; a++) {
  ...
  (E.testAllProps = y), Modernizr.addTest (
    'csstransitions',
    y ('transition', 'all', !0)
    ...
    if (e && (!t || 'webkitPerspective' in w.style)) {
      ...
      Modernizr.supports
        ...
        : ((n = '@media (transform-3d)'), t &&
            (n += ',(-webkit-transform-3d)')), (n +=
        '{#modernizr{width:7px;height:18px;margin:0;padding:0;border:0}}'), L (
        r + n,
        function (t) {
        ...
        keepTogether: {
          ...
          fn: function (e) {
            var t = e.offsets,
              ...
              a = p ? 'width' : 'height';
            return o[s] < r (i[d]) &&
              (e.offsets.popper[d] = r (i[d]) - o[a]), o[d] > r (i[s]) &&
              (e.offsets.popper[d] = r (i[s])), e;
          },
        },
        arrow: {
          order: 500,
          ...
          fn: function (e, o) {
            ...
            var r = e.placement.split ('-')[0],
              ...
              g = a ? 'bottom' : 'right',
              u = L (n)[l];
            d[g] - u < s[m] && (e.offsets.popper[m] -= s[m] - (d[g] - u)), d[
              m
            ] +
              u >
              s[g] &&
        ...
        computeStyle: {
          ...
          fn: function (e, t) {
            ...
            if (
              ((d = 'bottom' == c
                ? -f.height + h.bottom
                : h.top), (s = 'right' == u ? -f.width + h.right : h.left), a &&
                b)
            )
              (m[b] = 'translate3d(' + s + 'px, ' + d + 'px, 0)'), (m[
                c
